...
const locations = [
    ...
    },
    {
        ...
        badges: ['paid parking', 'outdoor seating'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['chicken'],
        badges: ['open late', 'outdoor seating'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['hall'],
        badges: ['contactless payments accepted', 'outdoor seating', 'paid parking'],
    ...
    },
    {
        name: 'District 7',
        category: 'food',
        subcategory: ['burgers', 'outdoor seating'],
    ...
    },
    {
        ...
        category: 'bar',
        subcategory: ['seafood'],
        badges: ['open late', 'outdoor seating', 'hookah', 'paid parking'],
    ...
    },
    {
        name: "A'dor",
        category: 'bar',
        badges: ['open late', 'hookah', 'DJ', 'live music', 'paid parking'],
    ...
    },
    {
        name: 'Locker Room',
        category: 'bar',
        badges: ['open late', 'hookah', 'outdoor seating'],
    ...
    },
    {
        name: 'Sugar Room',
        category: 'bar',
        badges: ['open late', 'paid parking', 'DJ', 'outdoor seating'],
    ...
    },
    {
        ...
        category: 'bar',
        subcategory: ['pizza'],
        badges: ['open late', 'outdoor seating', 'live music'],
    ...
    },
    {
        ...
        category: 'bar',    
        badges: ['open late', 'hookah', 'live music'],
    ...
    },
    {
        name: 'LOV3 Houston',
        category: 'bar',
        badges: ['open late', 'hookah', 'DJ', 'live music'],
    ...
    },
    {
        ...
        category: 'bar',
        badges: ['open late', 'DJ', 'outdoor seating'],
    ...
    // Music Venues
    {
        ...
        category: 'music',
        badges: ['paid parking', 'live music'],
    ...
    },
    {
        name: 'Axelrad',
        category: 'music',
        badges: ['paid parking', 'live music', 'outdoor seating'],
